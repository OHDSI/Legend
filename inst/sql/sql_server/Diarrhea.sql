...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (196523,4134607,201773,80141,4207688,4324838,197596,196620)and invalid_reason is null
