...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (321042,442289,441139,4132309,4185572,437894,4103295)and invalid_reason is null
...
WHERE C.ordinal = 1
AND C.condition_type_concept_id in (38000183,38000199,44786627,45756843,45756835,38000184,38000200,38000215,38000230)
