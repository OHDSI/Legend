...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (439235,4181216,444362,4273391,440925)and invalid_reason is null
...
where o.observation_concept_id in (SELECT concept_id from  #Codesets where codeset_id = 0)
) C
