...
cmData <- Legend:::constructCohortMethodDataObject(targetId = 739138112,
                                                             comparatorId = 797617112,
                                                             targetConceptId = 739138,
                                                             comparatorConceptId = 797617,
                                                             workFolder = workFolder)

cmData <- constructCustomCohortMethodDataObject(targetConceptId = 739138, workFolder = workFolder)
...
constructCustomCohortMethodDataObject <- function(targetConceptId, workFolder) {
  exposureSummary <- read.csv(file.path(workFolder, "exposureSummaryFilteredBySize.csv"))
  ...
  metaData <- list(targetId = targetConceptId, comparatorId = 0, attrition = counts)
  ...
  if (ffbase::any.ff(idx)) {
    ...
    # any(injectedOutcomes$daysToEvent < 0) min(outcomes$daysToEvent[outcomes$outcomeId == 73008])
