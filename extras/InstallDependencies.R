...
devtools::install_github("ohdsi/SqlRender", ref = "v1.5.2", dep = FALSE)
...
devtools::install_github("ohdsi/ParallelLogger", ref = "v1.0.0", dep = FALSE)
devtools::install_github("ohdsi/CohortMethod", ref = "v3.0.1", dep = FALSE)
devtools::install_github("ohdsi/EmpiricalCalibration", ref = "v1.3.6", dep = FALSE)
devtools::install_github("ohdsi/IcTemporalPatternDiscovery", ref = "v1.1.1", dep = FALSE)
devtools::install_github("ohdsi/MethodEvaluation", ref = "v0.3.1", dep = FALSE)
