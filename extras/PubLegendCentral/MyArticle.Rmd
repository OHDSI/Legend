...
```{r, make_balance, echo=FALSE, warning=FALSE, warning=FALSE, fig.align='center', fig.width=5, fig.height=5, out.width='70%', fig.cap="\\textbf{Patient characteristics balance before and after stratification.} As a rule-of-thum, all values $<0.1$ is generall considered well-balance \\citep{add}."}
...
Here we enumerate the guiding principles of LEGENE and provide linking details on study cohorts and design.
...
Please see the LEGEND `r indicationName` Study protocol (TODO URL) for complete specification of the `r targetName`, `r comparatorName` and `r outcomeName` cohorts using ATLAS.
